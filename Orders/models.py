...
class CustomerOrders(models.Model):
    ...
    ordered_date_time = models.DateTimeField(auto_now_add=True,null=True,blank=True)
    ...
    mode_of_payment = models.CharField(max_length=20,choices=Payment,null=True,blank=True ,default= None)
    ...
    is_confirmed            = models.BooleanField(null=True,blank=True ,default = False)
